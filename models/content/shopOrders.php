...
if (isset($_SESSION['user_id'])) 
{
    ...
    $records = $conn->query('SELECT * FROM shop_order where statut=0');
...
<head>
    ...
    <script>
        function confirmOrder(e){
            ...
            console.log(id);
            fetch("content/operationBD/updateShopOrder.php", {
                headers: {
            ...
            <tbody>
                <?php 
                    ...
                    while($donnees = $records->fetch()){
                        ...
                        print('<td>'); print($donnees['item_id'] ."\n"); print('</td>');
                                ...
                                <div class=\'modal-dialog\'>
                                  <div class=\'modal-content\'>
                                    ...
                                    <form>
                                        ...
                                        <br>
                                        <div class=\'mb-3\'>
                                            <label for=\'inputPassword7\' class=\'form-label\'> Item order </label>
                                            <input type=\'text\' name=\'lastname\' class=\'form-control\' id=\'lastname\' value=\'' . $donnees['item_id'] . '\' >
                                        </div>
                                        <br>
                                        <div class=\'mb-3\'>
